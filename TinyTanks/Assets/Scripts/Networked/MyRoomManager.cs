...
{
    readonly Dictionary<string, CrewSeat> seatsByKey = new();
    ...
    public override GameObject OnRoomServerCreateGamePlayer(NetworkConnectionToClient conn, GameObject roomPlayer)
    {
        ...
        if (rp != null && seatsByKey.TryGetValue(rp.chosenRoleKey, out var seat) && seat && !seat.taken)
        {
            seat.taken = true;
        ...
        Debug.LogWarning($"No seat for {rp?.chosenRoleKey}, falling back to default player prefab.");
